...
### We are on the same LAN, but I can't see my friend's world!
...
### Game crashes when connecting to a server!
...
### I logged into the server and can't move, and after a few seconds I get kicked out!
...
### The server asks me for my password, but I don't know any!
...
### I logged on to the server and it's all gone!
...
### The other player is bullying me!
Contact the server administration to resolve this issue.

### I lost my account from the Launcher and it had all the server items and purchases on it!
