...
4. Click "Need help?" in error window
    ![Error window with "Need help?" button](./img/need-help-crash-dialog-en.png)
    :::note[No error window? No "Need help?" button?]
    1. Click "Chat" button
        ![Click bottom-left button](./img/need-help-button-0-en.png)
    2. Select "Need help?" in drop-down menu
        ![Select "Need help?"](./img/need-help-button-1-en.png)
    :::
5. Send diagnostic data
    :::warning
    Don't forget to check the "send diagnostic data" box!
    :::
    ![Sending diagnostic data](./img/need-help-dialog-en.png)
    :::note
...
2. Open the "need-help" channel
    ![Find and open "need-help" channel](./img/discord-need-help-en.png)
3. Press "New post" button in top-right corner
    ![Press "New post" button](./img/discord-new-post-button-en.png)
...
5. Post a message and wait for a response.
    ![Press "Post" button](./img/discord-new-post-en.png)
