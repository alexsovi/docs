...
Этот мод считается наиболее универсальным. Для подключения друг к другу воспользуйтесь его "системой друзей" или командами `/worldhost tempip` (выдает временный адрес на 60 секунд) или `/worldhost ip` (постоянный адрес).
...
### Неверная сессия (попробуйте перезапустить игру)
Смотрите [выше](#invalid-session-try-restarting-your-game) - это та же самая ошибка.

### Connection refused: no further information
Если эта проблема проявляется на всех серверах, следовательно, что-то на вашем ПК (брандмауэр, антивирус, файрволл) блокируют подключение игры к серверам. Попробуйте временно отключить брандмаур, антивирус и файрволл или добавьте Java в их исключения.  
...
### Мы находимся в одной локальной сети, но я не вижу сервер друга!
Проверьте, что можете подключиться к другим серверам. Если нет - скорее всего, что-то на вашем ПК (брандмауэр, антивирус, файрволл) блокирует подключение игры к серверам. Попробуйте временно отключить брандмаур, антивирус и файрволл или добавьте Java в их исключения. В противном случае нужно выполнить аналогичные действия на стороне друга.

### При подключении к серверу игра крашится!
...
Ничего не помогает? Вы можете обратиться в нашу [техническую поддержку](../support)

### Я вошел на сервер и не могу двигаться, и через несколько секунд меня выкидывает!
...
### Сервер спрашивает у меня пароль, но я не знаю никаких паролей!
...
### Другой игрок меня обижает!
Обратитесь к представителям администрации сервера для урегулирования конфликта.

### У меня пропал аккаунт из лаунчера, а на нём были все донаты!
