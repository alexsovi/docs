...
Аналог мода NgrokLAN, тоже использует сервис [Ngrok](https://ngrok.com/), но проще в настройке. На [странице мода](https://modrinth.com/mod/lan-extender) присутствует подробная инструкция с картинками.
