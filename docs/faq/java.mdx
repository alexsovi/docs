...
Для запуска <RedirHost path="/jar">jar-версии</RedirHost>, <RedirHost path="/latest">бета-версии</RedirHost> Legacy Launcher и многих установщиков модов вам потребуется установить Java.
