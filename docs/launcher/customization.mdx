...
### Примеры тем {#flatlaf-examples}
```mdx-code-block
<Tabs>
<TabItem value="Darcula">
<img src={require('./img/theme-darcula.jpg').default} alt="Скриншот окна лаунчера с темой Darcula" />
</TabItem>
<TabItem value="IntelliJ">
<img src={require('./img/theme-intellij.jpg').default} alt="Скриншот окна лаунчера с темой IntelliJ" />
</TabItem>
<TabItem value="Solarized Light">
<img src={require('./img/theme-solarized-light.jpg').default} alt="Скриншот окна лаунчера с темой Solarized Light" />
</TabItem>
<TabItem value="Solarized Light High-Contrast">
<img src={require('./img/theme-solarized-light-highcontrast.jpg').default} alt="Скриншот окна лаунчера с темой Solarized Light High-Contrast" />
</TabItem>
<TabItem value="Solarized Dark">
<img src={require('./img/theme-solarized-dark.jpg').default} alt="Скриншот окна лаунчера с темой Solarized Dark" />
</TabItem>
<TabItem value="Material Deep Ocean">
<img src={require('./img/theme-material-deep-ocean.jpg').default} alt="Скриншот окна лаунчера с темой Material Deep Ocean" />
</TabItem>
</Tabs>
```

## Темы лаунчера {#legacy}
